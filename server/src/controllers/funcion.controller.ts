...
export const getAsientosOcupados = async (req: Request, res: Response) => {
...
export const buscarIdFuncion = async (req: Request, res: Response) => {
  const { peliculaId, fecha, hora } = req.query;
...
// CRUD RUTAS
export const getFunciones = async (req: Request, res: Response) => { 
  try {
...
export const getFuncionById = async (req: Request, res: Response) => {
  const { id } = req.params;
  try {
...
export const postFuncion = async (req: Request, res: Response) => {
  const { body } = req;
  try {
...
export const postGuardarAsientos = async (req: Request, res: Response) => {
  const { funtion_id, seat_codes } = req.body;

  console.log('Guardar asientos:', { funtion_id, seat_codes });
  ...
  try {
    ...
    console.log('Asientos aprobadas, insertando', seat_codes.length, 'asientos');
